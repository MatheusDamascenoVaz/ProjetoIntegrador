...
public class RelatorioProdutosVencidosMySQL

{

    public DatabaseService _databaseService;

    public RelatorioProdutosVencidosMySQL(DatabaseService databaseService)
    {
        _databaseService = databaseService;
    }

    public void GerarRelatorioProdutosVencidos()
    {
        ...
        SaveFileDialog saveFileDialog = new SaveFileDialog
        {
            ...
            FileName = $"RelatorioProdutosVencidos_{DateTime.Now:yyyyMMdd}.pdf"
        };
        ...
        if (saveFileDialog.ShowDialog() == DialogResult.OK)
        {
            try
            {
                ...
                // Adicionar título
                Paragraph titulo = new Paragraph("RELATÓRIO DE PRODUTOS VENCIDOS",
                ...
                DataTable dt = GetProdutosVencidos();
    ...
    private DataTable GetProdutosVencidos()
    {
        string query = @"
